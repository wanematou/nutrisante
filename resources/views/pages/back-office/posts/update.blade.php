                            ...
                            <div class="card">
                                ...
                                <form action="{{ route('posts.update', $post)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-4">
                                            <label for="online"  class="col-md-3 form-label">en ligne?</label>
                                            <div class="">                                            
                                               
                                                <input name="online" type="checkbox" @if($post->online) checked @endif>
                                        ...
                                        <div class="row">                                       
                                            ...
                                            <div class="mb-4">
                                                <textarea class=" @error('contenue') is-invalid @enderror content" name="content">{{$post->content}}</textarea>
                                            </div>
                                        </div>
